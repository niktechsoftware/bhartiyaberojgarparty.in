                        ...
                        <div class="col-md-12">
                            <div class="panel panel-white">
                            	<div class="panel-body">
                            		<div class="row">
                            			<div class="col-md-12">
                            				<form class="form-horizontal" action="<?php echo base_url()?>apanel/saveGallery" method="post" enctype="multipart/form-data">
                                    ...
                                    <table id="example" class="display table" style="width: 100%; cellspacing: 0;">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                              ...
                                              <td><img width="50" height="50" src="<?php echo base_url();?>assets/images/gallery/<?php echo $row->img; ?>" alt="" /></td>
                                                <td><?php echo $row->dt; ?></td>
                                                <td>
                                                	<a href="<?php echo base_url();?>apanel/deleteGallery/<?php echo $row->id;?>">
                                                		Delete
                                                	</a>
                                                </td>
                                            </tr>
